...
function buildGptMidformPrompt(geminiAnalysis, options = {}) {
  ...
  return [
    ...
    '- For dialogue_quote Korean subtitles, write caption_kr_dialogue as direct spoken subtitle text, not narration. Good: "넌 못 지나가." Bad: "그는 넌 못 지나간다고 말합니다."',
    '- Each caption_kr_dialogue item must be one compact spoken line: preserve the meaning, but remove speaker-reporting tails such as "라고 말합니다", "라고 묻습니다", "라고 대답합니다".',
    '- Keep dialogue subtitles short enough for one on-screen caption. Prefer 6-18 Korean characters when natural, and avoid explanatory clauses that are not literally spoken.',
